	...
	PLAY(0) {
		{
			...
			addPacket(Direction.CLIENTBOUND, 0x05, S05SpawnPosition.class);
			addPacket(Direction.CLIENTBOUND, 0x08, S08PlayerPositionLook.class);
			addPacket(Direction.CLIENTBOUND, 0x0C, S0CSpawnPlayer.class);
			addPacket(Direction.CLIENTBOUND, 0x13, S13DestroyEntities.class);
			addPacket(Direction.CLIENTBOUND, 0x14, S14Entity.class);
			addPacket(Direction.CLIENTBOUND, 0x15, S14Entity.S15EntityRelativeMove.class);
			addPacket(Direction.CLIENTBOUND, 0x16, S14Entity.S16EntityLook.class);
			addPacket(Direction.CLIENTBOUND, 0x17, S14Entity.S17EntityLookMove.class);
			addPacket(Direction.CLIENTBOUND, 0x18, S18EntityTeleport.class);
			addPacket(Direction.CLIENTBOUND, 0x21, S21ChunkData.class);
			addPacket(Direction.CLIENTBOUND, 0x23, S23PacketBlockChange.class);
			addPacket(Direction.CLIENTBOUND, 0x26, S26MapChunkBulk.class);
			addPacket(Direction.CLIENTBOUND, 0x38, S38PlayerListItem.class);
			...
			addPacket(Direction.SERVERBOUND, 0x04, C03Player.C04PlayerPosition.class);
			addPacket(Direction.SERVERBOUND, 0x05, C03Player.C05PlayerLook.class);
			addPacket(Direction.SERVERBOUND, 0x06, C03Player.C06PlayerPositionLook.class);
			addPacket(Direction.SERVERBOUND, 0x10, C10CreativeInventoryAction.class);
